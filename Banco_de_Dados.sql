...
INSERT INTO noticia(titulo, resumo, texto, email_Usuario) VALUES ('Joe Biden anuncia pré-candidatura à presidência dos EUA','O anúncio foi feito no Twitter, com vídeos em inglês e espanhol. Biden ainda precisa vencer a nomeação do Partido Democrata para se tornar candidato nas eleições presidenciais, marcadas para novembro do ano que vem.',
...
Segundo a agência de notícias Reuters, a primeira aparição pública de Biden como pré-candidato deve ser na próxima segunda (29), em um evento na cidade de Pittsburgh, estado da Pensilvânia, com integrantes de sindicatos — considerados um eleitorado chave.','marcioamorosino@hotmail.com');

INSERT INTO noticia(titulo, resumo, texto, email_Usuario) VALUES ('Mala de mão fora do padrão começa a ser despachada em aeroportos','Medida começa a ser adotada em aeroportos de Brasília, Curitiba, Campinas e Natal. Bagagem pode ser taxada por companhias aéreas',
...
Segundo a Abear, as companhias aéreas disponibilizam tarifas que incluem gratuitamente o despacho de bagagem. Caso o cliente precise pagar, os preços partem de R$ 59. ','vitoriapaulafofa@ig.com.br');

INSERT INTO noticia(titulo, resumo, texto, email_Usuario) VALUES ('Fãs de Microsoft Paint existem - e comemoram decisão da empresa de manter programa no Windows','Empresa havia sinalizado que poderia remover o programa de criação e dição de imagens do Windows. Agora, confirmou que, "por enquanto", ele fica',
...
O assunto voltou aos holofotes nas últimas semanas, quando usuários questionaram se ele seria parte da próxima atualização do Windows 10, que será lançada em maio."Ela é uma porcaria, não é boa, e eu acho que gosto de usar algo que é verdadeiramente uma "ferramenta de lixo" para fazer arte."-diz o artista Lorikeet.','vitoriapaulafofa@ig.com.br');

INSERT INTO noticia(titulo, resumo, texto, email_Usuario) VALUES ('Notre-Dame: primeiro alerta de fogo teria falhado por erro humano','Segundo alarme de incêndio soou 20 minutos após o primeiro, mas chamas já haviam se espalhado e era impossível conter seu avanço pela cobertura',
...
A instalação anti-incêndios estava projetada para apagar um incêndio no início, mas com os atrasos registrados na localização do mesmo, se tornou grande demais, revelou ontem o jornal Le Canard Enchainé.','marcioamorosino@hotmail.com');

INSERT INTO noticia(titulo, resumo, texto, email_Usuario) VALUES ('"Como sou cirurgiã de câncer de mama, pensei que não aconteceria comigo"',"Liz O'Riordan foi diagnosticada com câncer de mama pela primeira vez em 2015",
...
O'Riordan, hoje com 43 anos, afirma que não são muitos médicos que desenvolvem as doenças em que se especializam; Certamente, ninguém em seu departamento no Hospital Ipswich, em Suffolk, tinha câncer de mama.",'vitoriapaulafofa@ig.com.br');

INSERT INTO noticia(titulo, resumo, texto, email_Usuario) VALUES ('Produtos para estimular o convívio entre gerações','Universidade de Stanford anuncia os vencedores da sexta edição do “Desafio do design”',
